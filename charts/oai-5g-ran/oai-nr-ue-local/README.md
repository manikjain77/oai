...
This helm-chart is only tested for [RF Simulated oai-nr-ue-local](https://gitlab.eurecom.fr/oai/openairinterface5g/-/blob/develop/radio/rfsimulator/README.md). You can read about the design of [oai-nr-ue-local](https://gitlab.eurecom.fr/oai/openairinterface5g/-/blob/develop/doc/nr-ue-design.md). You can use these charts with:
- USRP B2XX
- USRP N3XX
- USRP X3XX
